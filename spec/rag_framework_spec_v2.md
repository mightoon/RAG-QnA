...
class RetrievalPathConfig(BaseModel):
    ...
    bm25:       bool = True     # ES 全文关键词检索
    graph:      bool = False    # Neo4j/NebulaGraph 图谱检索（默认关，需用户主动开启）
    structured: bool = False    # MySQL NL2SQL 结构化查询（默认关）
...
class MySQLMetaStore:
    ...
    def __init__(self, config: MySQLConfig):
        ...
        self._engine  = create_async_engine(dsn, pool_size=config.pool_size)
